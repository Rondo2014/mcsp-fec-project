...
const HomeHardware = () => {
  return (
    <div className="flex justify-center mt-8">
      <a href="https://store.steampowered.com/app/1675200/Steam_Deck/?utm_source=steamhome&snr=1_4_4__147">
        <img
      ...
      <a href="https://store.steampowered.com/sub/354231/?snr=1_4_4__147">
        <img
